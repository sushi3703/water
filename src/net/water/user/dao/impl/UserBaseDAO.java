...
public class UserBaseDAO extends BaseDAO implements IUserBaseDAO {
	...
	public List<UserBaseEntity> queryUserBases(UserBaseDto userBaseDto) throws DataBaseException {
		String sql = "select b.user_id,b.create_time,b.department,b.job_title,b.qq,b.mobile,b.note,l.uname,l.email,l.type,l.team_id from w_user_base b,w_user_login l where b.user_id=l.user_id and l.status=1 and l.type>0";
