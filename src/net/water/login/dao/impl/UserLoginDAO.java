...
public class UserLoginDAO extends BaseDAO implements IUserLoginDAO {
	...
	public UserLoginEntity queryUserLoginByEmail(UserLoginEntity userLoginEntity) {
		String sql = "select user_id,uname,email,upwd,type,status,qq_open_id,qq_access_token,team_id from w_user_login where email=? and upwd=? limit 1";
	...
	public UserLoginEntity queryUserLoginByQqOpenId(UserLoginEntity userLoginEntity) {
		String sql = "select user_id,uname,email,type,status,qq_open_id,qq_access_token,team_id from w_user_login where qq_open_id=? limit 1";
	...
	public UserLoginEntity queryUserLoginByUserId(UserLoginEntity userLoginEntity) {
		String sql = "select user_id,uname,email,type,status,qq_open_id,qq_access_token,team_id from w_user_login where user_id=? limit 1";
