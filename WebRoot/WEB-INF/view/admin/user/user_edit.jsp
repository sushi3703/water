...
<!--固定头部结束-->
  <div class="container-fluid">
    ...
    <ul class="nav nav-tabs nav-tabs-main">
          <li><a href="${pageContext.request.contextPath}/admin/user/index.action?${userDto.queryStr}">用户列表</a></li>
          <li class="active"><a data-toggle="tab" href="#1"><i class="icon-th-list"></i><span>编辑用户基本信息</span></a></li>
    </ul>
    <div class="tab-content">
    <div id="1" class="tab-pane active">
    <div class="box">
    <form action="${pageContext.request.contextPath}/admin/user/save.action" method="post"  class="form-horizontal">
    <input type="hidden" id="queryStr" name="queryStr" value="${userDto.queryStr}" />
    <input type="hidden" name="formToken" value="${userDto.formToken}" />
